$(document).ready(function () {
   ...
   // Genere les jours de la semaine dans l'entête
   function generateDaysInWeek() {
       var days = ['lun.', 'mar.', 'mer.', 'jeu.', 'ven.', 'sam.', 'dim.'];
       // on rempli l'entête (jours de la semaine)
       $('#week').append('<tr class="entete"></tr>');
       for(var d = 0; d < days.length; d++){
           $('.entete').append('<td>'+days[d]+'</td>');
       }
   }
